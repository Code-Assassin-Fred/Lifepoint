        ...
        return (
            <div className="max-w-4xl mx-auto animate-in fade-in duration-300">
                <button onClick={() => { setSelectedPlan(null); setCurrentDay(0); setUserAiMessages([]); }} className="flex items-center gap-2 text-zinc-500 hover:text-zinc-900 mb-6 transition-colors font-bold">
                    <ChevronLeft size={18} /> Back to Growth & Mentorship Plans
                </button>
                ...
                {/* AI Companion for Growth & Mentorship */}
                <div className="bg-gradient-to-br from-[#ccf381]/20 to-green-50/20 rounded-3xl p-6 border border-[#ccf381]/30">
                    <div className="flex items-center gap-2 mb-4">
                        ...
                        <span className="font-bold text-zinc-900">Growth & Mentorship Assistant</span>
                    </div>
    ...
    return (
        <div className="max-w-6xl mx-auto space-y-8">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-3xl font-bold text-zinc-900 tracking-tight">Growth & Mentorship</h1>
                    <p className="text-zinc-500 mt-1">Structured plans and mentorship to help you reach your full potential.</p>
                </div>
                {isAdmin && (
                    <button
