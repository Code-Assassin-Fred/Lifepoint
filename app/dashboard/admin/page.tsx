                ...
                <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
                    {adminTools.map((tool) => {
                        ...
                        return (
                            ...
                            >
                                <div className="w-10 h-10 rounded-lg bg-gray-100 text-gray-600 flex items-center justify-center mb-3 group-hover:bg-red-50 group-hover:text-red-600 transition-colors">
                                    <Icon size={20} />
                                </div>
